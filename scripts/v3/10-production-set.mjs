...
const a1 = {
  portrait: () => [
    ...
    HR(72, 1008, 760),
    T("Devin handles the task in your repo\nand opens a pull request for you to review.", { x: 72, y: 812, size: 42, lh: 56, w: 400, tr: -0.5 }),
  ...
  square: () => [
    ...
    HR(72, 1008, 596),
    T("Devin handles the task in your repo\nand opens a pull request for you to review.", { x: 72, y: 636, size: 38, lh: 50, w: 400, tr: -0.5 }),
...
const a2 = {
  portrait: () => [
    ...
    T("Review the changes before you merge.", { x: 72, y: 900, size: 42, lh: 56, w: 400, tr: -0.5 }),
  ...
  square: () => [
    ...
    T("Review the changes before you merge.", { x: 72, y: 690, size: 38, lh: 50, w: 400, tr: -0.5 }),
...
const b2 = {
  portrait: () => [
    ...
    T("Managed with automated Devin playbooks\nthrough a custom-built\norchestration system.", { x: 72, y: 856, size: 40, lh: 52, w: 400, tr: -0.5 }),
    T("Reported by FE fundinfo. Custom implementation,\nnot a typical result.", { x: 72, y: 1036, size: 32, lh: 42, w: 400, color: MUTED }),
  ...
  square: () => [
    ...
    T("Managed with automated Devin playbooks\nthrough a custom-built\norchestration system.", { x: 72, y: 634, size: 36, lh: 46, w: 400, tr: -0.5 }),
    T("Reported by FE fundinfo. Custom implementation,\nnot a typical result.", { x: 72, y: 796, size: 28, lh: 36, w: 400, color: MUTED }),
